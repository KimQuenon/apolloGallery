 ...
 */
final class Version20240401100406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auction (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, artwork_id INT NOT NULL, amount DOUBLE PRECISION NOT NULL, submission_date DATETIME NOT NULL, INDEX IDX_DEE4F593A76ED395 (user_id), INDEX IDX_DEE4F593DB8FFA4 (artwork_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
